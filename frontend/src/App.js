...
import { 
  ...
  UserPlus, Clock, AlertCircle, Stethoscope
} from "lucide-react";
...
function AppContent({ darkMode, setDarkMode, sidebarCollapsed, setSidebarCollapsed }) {
        ...
        <header className="h-16 glass-effect border-b border-border flex items-center justify-between px-6 z-10">
          <div className="flex items-center gap-4">
            <div>
              ...
              <p className="text-xs text-muted-foreground">Serving the community with care</p>
            </div>
          </div>
